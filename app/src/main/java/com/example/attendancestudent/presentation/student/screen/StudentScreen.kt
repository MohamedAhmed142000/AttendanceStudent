    ...
    import com.example.attendancestudent.presentation.student.screen.add_dialog.AddStudentDialog
    import com.example.attendancestudent.presentation.student.screen.edit_dialog.EditStudentDialog
    import com.example.attendancestudent.presentation.student.screen.topbar.TopBarApp
                ...
                LazyColumn {
                    items(displayedStudents) { student ->
                        StudentItem(
                            ...
                            onMarkAbsent = { viewModel.markAbsent(student.id) }
                        )
                    }
                }
